...
**在线预览所有页面**: https://stitch.withgoogle.com/project/[projectId]

## 2. Page Summary

| Page | Stitch Screen | Description |
|------|--------------|-------------|
| Homepage | [screenId] | Hero + features + CTA |
| Dashboard | [screenId] | Stats + charts + table |
| ... | ... | ... |

## 3. Design System (extracted from Stitch HTML)
### Colors
...
- **在线预览**: https://stitch.withgoogle.com/project/[projectId]
...
1. Git add design spec (NOT .forge/design-html/ — gitignored)
2. Commit and push
3. Output:
   ```
   🔴 审批门控
   ...
   设计规范文档: https://github.com/<org>/<repo>/blob/main/docs/forge/P3-design-spec.md

   页面清单:
   | 页面 | 描述 |
   | Homepage | Hero + 特性 + CTA |
   | Dashboard | 统计 + 图表 |
   | ... | ... |
...
**关键**: 审批时必须提供 Stitch 在线预览链接，让审批人在手机/电脑上直接查看每个页面的真实设计效果。
